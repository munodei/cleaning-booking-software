...
<head>
    ...
    <title>{{ get_option('site_title') }}| {{ __('Confirm Password') }}</title>
                            ...
                            @csrf
                                    ...
                                    <div class="tab-pane" id="about">
		                            	<div class="row">
                                            ...
                                            <h5 class="info-text"> {{ __('Confirm Password') }}</h5>
                                            
                                            <span class="info-text" style="color:green;"> {{ __('Please confirm your password before continuing.') }}</span>
