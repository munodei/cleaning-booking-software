  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="{{ route('services') }}">Services</a>
        <!-- Form -->
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="#" data-toggle="modal" data-target="#AddCleaner" class="btn btn-sm btn-primary">Add Services</a>
                </div>
              ...
              <table class="table align-items-center table-flush">
                ...
                @foreach($services as $service)
                  <tr>
                    ...
                    <td>
                      <i class="far fa-eye text-success mr-3" title="View Service"></i>
                      <i class="fas fa-edit text-warning mr-3" title="Edit Service"></i>
                      <i class="fas fa-trash text-danger mr-3" title="Delete Service"></i>
                    </td>
                  </tr>
                @endforeach
