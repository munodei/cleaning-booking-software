...
class PaymentController extends Controller
{
    ...
    public function index(){
        ...
        $user = Auth::user();
            ...
            $payments = Payment::whereUserId($user->id)->with('user')->paginate(50);


        return view('user-payments', compact('title', 'payments'));
    }
    ...
    public function paypalNotify(Request $request, $transaction_id){
        ...
        $appointment = \App\Appointment::find($payment->appointment_id);
