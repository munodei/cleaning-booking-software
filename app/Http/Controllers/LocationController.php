...
class LocationController extends Controller
{
    ...
    public function getLocation(Request $request,$id){
        ...
        return json_encode(Location::where('id',intval($id))->first());
    }
    ...
    public function serviceLocation(){
        ...
        return view('admin.service-locations',compact('title','countries','states','city','neighbourhoods','suburbs'));
    }
    ...
    public function editLocation(Request $request){
        ...
        $location =  Location::find(intval($id_location));
        ...
        $location->suburb_id      = $suburb_id ?? null;
        $location->postal_code    = $postal_code ?? null;

        $location->save();

        if(isset($id_location) && $id_location !='')
        return redirect()->back()->with('success','You have successfully added a new location');

        return redirect()->back()->with('success','You have successfully updated your location details');
    ...
    public function deleteLocation(Request $request){
        ...
        $mesgs = [
                    'location_id.required' => 'Something went wrong please try again!'
                ];
        $this->validate($request,$rules,$mesgs);

        extract($_POST);

        $location = Location::find(intval($location_id));

        $location->delete_at = date('Y-m-d h:i:s');

        $location->save();

        return redirect()->back()->with('error','You have successfully deleted a location');
