    ...
    public function boot(){
        ...
        try {
            ...
            view()->composer('*', function ($view) {
                ...
                $view->with(['lUser' => $loggedUser, 'enable_monetize' => $enable_monetize, 'countries' => $countries,   'current_country' => $current_country, 'current_lang' => $current_lang, 'header_menu_pages'=>$header_menu_pages,'show_in_footer_menu'=>$show_in_footer_menu]);
            });
